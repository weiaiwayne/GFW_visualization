...
# the script was written by Dr. Gregory Saxton (https://github.com/gdsaxton) and modified by The Curiosity Bits
...
def get_data(kid, max_id=None):
    try:
        d = t.search(q=kid, count = '200', max_id = max_id) # lang = 'en'
...
class Scrape:
    def __init__(self):    
        engine = sqlalchemy.create_engine("sqlite:///GFW_tweets starting 9-1-2015.sqlite", echo=False)  
